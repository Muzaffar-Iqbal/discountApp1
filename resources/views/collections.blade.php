...
<html lang="{{ app()->getLocale() }}">
                ...
                <div class="container custom-container">
                    ...
                    <div class="topBtn">
						<div class="checkbox" style="border: none;">
						  <label><input type="checkbox" class="filter-products" @if ($filter == 'discount'){ checked="checked" } @endif value="discount">Show Discountable Collections</label>
						</div>
					</div>
					<div class="alert alert-danger" id="selectMsg" style="display: none">
					  <strong>Alert !</strong> Select Collections First.
					</div>

                    <div class="productListings">
					<?php $check=(array)$collects; ?>
					@if(!$check)
						<div class="alert alert">
						  <strong>Alert !</strong>  Discountable Collections Not Found.
						</div>
					@else
                        <div class="title">
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <div id="disableGroup" class="btn btn-primary"
                             style="width: 36%; margin: auto; display: none;">Remove Discount Group</div>
                ...
                jQuery(document).ready(function () {
                    $('.filter-products').change(function(){
						if(this.checked) {
							window.location.href="/collections?filter_by=discount";
						}else{
							window.location.href="/collections?filter_by=All";
						}
	...
	$(document).on('change', '.productCheckBox:checkbox', function (e) {
