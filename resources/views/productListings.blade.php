                    ...
                    <div class="container custom-container">
                        ...
                        <div class="topBtn">
							<div class="checkbox" style="border: none;">
							  <label><input type="checkbox" class="filter-products" @if ($filter == 'discount'){ checked="checked" } @endif value="discount">Show Discountable Products</label>
							</div>
                        </div>
						<div class="alert alert-danger" id="selectMsg" style="display: none">
						  <strong>Alert !</strong> Select Products First.
						</div>
						...
						@if(!$products)
							<div class="alert alert">
							  <strong>Alert !</strong>  Discountable Products Not Found.
							</div>
						@else
                            <div class="title">
                                <h3 class="col-md-6">Product Title</h3>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <div id="disableGroup" class="btn btn-primary"
                                         style="width: 36%; margin: auto; display: none;">Remove
                                        Discount Group</div>
            ...
            <script>
                $(document).ready(function () {
                    ...
                    $('.filter-products').change(function(){
						if(this.checked) {
							window.location.href="/products?filter_by=discount";
						}else{
							window.location.href="/products?filter_by=all";
						}
